...
/*
EventsApiService GetEventByTickerCached
...
func (a *EventsApiService) GetEventByTickerCached(ctx context.Context, ticker string) (GetEventByTickerResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue GetEventByTickerResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/events/{ticker}"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GetEventByTickerResponse
