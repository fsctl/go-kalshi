...
/*
SeriesApiService GetSeriesByTicker
...
func (a *SeriesApiService) GetSeriesByTicker(ctx context.Context, seriesTicker string) (GetSeriesByTickerResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue GetSeriesByTickerResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/series/{series_ticker}"
	localVarPath = strings.Replace(localVarPath, "{"+"series_ticker"+"}", fmt.Sprintf("%v", seriesTicker), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GetSeriesByTickerResponse
